...
<html>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <img src="assets/futemaster-removebg-preview.png" alt="">
            <h2 id="text">FuteMaster</h2>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fa-solid fa-futbol"></i>Esportivos
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="#">Bolas</a>
                            <a class="dropdown-item" href="#">Bombinhas</a>
                            <a href="#" class="dropdown-item">Outros</a>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa-solid fa-shirt"></i>Roupas
                                </a>
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="#">Natação</a>
                                    <a class="dropdown-item" href="#">Calça</a>
                                    <a class="dropdown-item" href="#">Blusas</a>
                                    <a class="dropdown-item" href="#">Camisa de time</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa-solid fa-bottle-water"></i>Acessórios
                                </a>
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="#">Meias</a>
                                    <a class="dropdown-item" href="#">Cadarços</a>
                                    <a class="dropdown-item" href="#">Garrafinhas</a>
                            </li>
                            <li>
                                <c:if test="${adm}">
                                    <a class="nav-link dropdown-toggle" href="./cadastroproduto">Cadastrar Produto</a>
                                </c:if>
                            </li>
                </ul>
            ...
            <c:choose>
                <c:when test="${usuario == 0}">
                    <a href="./logincontroler"><button class="btn btn-outline-success my-2 my-sm-0 conta" ><i class="fa-solid fa-user"></i></button></a>
                        </c:when>
                        <c:otherwise>
                    <form action="deslogar" method="post">
                        <button class="btn btn-outline-success my-2 my-sm-0 conta" >Sair</button>
                    </form>
                </c:otherwise>
            </c:choose>
    ...
    <main>
        ...
        <div class="cards">
            <c:forEach items="${produto}" var="p">
                <div class="card">
                    <div class="image"> <img  class="image" src="data:image/jpeg;base64,${p.imagemBase64}" alt="${p.nome}"></div>
